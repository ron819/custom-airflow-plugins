...
The first part is the latest bigquery hook from airflow repo to allow setting using legacy sql
At the end is a custom plugin that allows branching on bigquery data
"""
# pylint: disable=W0221,C0103,W0231,W0102,W0511,W0715,C0302,C0411
# pylint: disable=C4001,C0111,C0412,C0330,C0301,C0325,C1801
# pylint: disable=E0401
# pylint: disable=R1705,R0912,R0914,R0913,R0903
...
class BigQueryLatestHook(GoogleCloudBaseHook, DbApiHook, LoggingMixin):
    """
    ...
    def __init__(self,
                 ...
                 delegate_to=None,
                 use_legacy_sql=True):
        super(BigQueryLatestHook, self).__init__(
